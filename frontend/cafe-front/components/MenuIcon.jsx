...
const MenuIcon = ({ activeId, setActiveId }) => {
    ...
    return (
        <div id="menuType" className="flex flex-col items-center gap-5 md:py-16 py-5 text-gray-800">
            <h1 className="text-3xl md:text-5xl font-black " style={{ color: colors.color.fontYellow }}>{t("menu.title")}</h1>
            <p className="px-4 pt-3 sm:px-0 sm:pt-5 text-xl md:text-2xl font-semibold " style={{ color: colors.color.fontSubTitle }}>{t("menu.subtitle")}</p>
