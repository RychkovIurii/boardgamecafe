...
const MyBookings = () => {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            Swal.fire({ icon: 'success', title: 'Deleted!', text: 'The booking has been deleted.' });
        } catch (error) {
            console.error('Error deleting booking:', error);
            Swal.fire({ icon: 'error', title: 'Delete Failed', text: 'Something went wrong while deleting the booking.' });
        }
    };
